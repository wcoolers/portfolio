            ...
            <Container className="p-5 mt-5 m-auto">
                <Row>
                    <Col>
                        ...
                        <div className="limit">
                            <p>A curious mind and a software developer with technical skills in Java, SpringBoot, C# (.NET), PHP, Python, Nodejs, Swift (IOS), Kotlin (Android), JavaScript, Angular, React, CSS, HTML, XML, Bash, Git, SQL, No SQL databases amongst others. I also have experience writing unit and functional tests with JUnit, selelium and a host of other tools. 
                                </p>
